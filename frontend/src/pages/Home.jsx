          ...
          <div className='text-center mb-28'>
            ...
            <div className='flex flex-wrap justify-center gap-4 mt-10'>
              ...
              <motion.button onClick={() => {
                ...
                whileHover={{ opacity: 0.9, scale: 1.03 }}
                whileTap={{ opacity: 1, scale: 0.98 }}
                className='  px-10 py-3 rounded-full hover:bg-gray-300 border border-gray-300 transition'>
                View History
              </motion.button>
            </div>
          </div>
        ...
        items-center gap-10 mb-28'>
            {
              ...
              },
              {
                ...
                <motion.div key={index}
                  ...
                  className={`relative bg-white rounded-3xl border-3 border-green-100 
              havor:border-green-500 p-10 w-80 max-w-[90%] shadow-md hover:shadow-2xl transition-all duration-300
              ${index === 0 ? "rotate-[-4deg]" : ""}
              ${index === 1 ? "rotate-[-3deg]" : ""}
              ${index === 0 ? "rotate-[-3deg]" : ""}
              `}>
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  },
                  {
                    ...
                    desc: "SDetailed strengths, weaknesses and improvement insights."
                  },
                  {
                    image: evalImg,
                    icon: <BsBarChart size={20} />,
